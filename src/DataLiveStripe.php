...
use datalive\serviceinfrastructure\Infrastructure;
...
class DataLiveStripe
{
   ...
   public function getCostumerId($account_id){
      ...
      return $this->infrastructure->getService($account_id,'stripe');
   ...
   public function createConstumer($account_id){
      ...
      try{
        ...
        //if(empty($user)){
          ...
          $this->infrastructure->setService($account_id,'stripe',['customer_id' => $customer['id']]);
       /* }
        else{
